...
namespace GuildCars.Data.Mock
{
    public class EmployeeRepositoryMock : IEmployeeRepository
    {
        ...
        {
            new Employee
            { EmployeeId = 1, EmployeeFirstName = "System", EmployeeLastName = "Administrator", EmployeeEmail = "admin@guildcars.com", RoleName = "Admin", Password="testing123" },
            new Employee
            { EmployeeId = 2, EmployeeFirstName = "Sales", EmployeeLastName = "Person", EmployeeEmail = "sales@guildcars.com", RoleName = "Sales", Password="testing123" },
            new Employee
            { EmployeeId = 3, EmployeeFirstName = "Disabled", EmployeeLastName = "User", EmployeeEmail = "disabled@guildcars.com", RoleName = "Disabled", Password="testing123" }
        };
