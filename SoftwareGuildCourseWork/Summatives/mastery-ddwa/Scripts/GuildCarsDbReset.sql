...
BEGIN
	...
	INSERT INTO Employee (EmployeeId, RoleId, EmployeeFirstName, EmployeeLastName, EmployeeEmail, [Password])
	VALUES
		(1, 1, 'System', 'Administrator', 'admin@guildcars.com', 'testing123'),
		(2, 2, 'Sales', 'Person', 'sales@guildcars.com', 'testing123'),
		(3, 3, 'Disabled', 'User', 'disabled@guildcars.com', 'testing123');
	...
	VALUES
		(1, 1, 1, 'MN', '4S4BSACC2J3216989', 'Stephen', 'stephen@email.com', '111-111-1111', '100 Main Street', null, 'Minneapolis', '55111', 19000, '8/2/2021'),
