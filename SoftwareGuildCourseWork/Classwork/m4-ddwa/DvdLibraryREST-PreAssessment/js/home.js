        ...
        error: function () {
            $('#errorMessages')
                .append($('<li>')
                    ...
                    .text('Error calling web service. EDIT DVD NOT WORKING Please try again later.'));
        }
    });
}
...
function searchDVDs() {
    ...
    if ($('#searchCategory').val() == '' || $('#searchTerm').val() == '') {
        ...
        $.ajax({
            type: 'GET',
            url: 'https://tsg-dvds.herokuapp.com/dvds/title/' + $('#searchTerm').val(),
            success: function (DVDArray) {
                clearDVDTable();
                $.each(DVDArray, function (index, DVD) {
                    var title = DVD.title;
        ...
        $.ajax({
            type: 'GET',
            url: 'https://tsg-dvds.herokuapp.com/dvds/year/' + $('#searchTerm').val(),
            success: function (DVDArray) {
                clearDVDTable();
                $.each(DVDArray, function (index, DVD) {
                    var title = DVD.title;
        ...
        $.ajax({
            type: 'GET',
            url: 'https://tsg-dvds.herokuapp.com/dvds/director/' + $('#searchTerm').val(),
            success: function (DVDArray) {
                clearDVDTable();
                $.each(DVDArray, function (index, DVD) {
                    var title = DVD.title;
        ...
        $.ajax({
            type: 'GET',
            url: 'https://tsg-dvds.herokuapp.com/dvds/rating/' + $('#searchTerm').val(),
            success: function (DVDArray) {
                clearDVDTable();
                $.each(DVDArray, function (index, DVD) {
                    var title = DVD.title;
