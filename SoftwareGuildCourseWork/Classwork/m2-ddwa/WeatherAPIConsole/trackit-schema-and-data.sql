...
CREATE TABLE Task (
	...
	CONSTRAINT fk_Task_TaskType FOREIGN KEY (TaskTypeId)
		REFERENCES TaskType(TaskTypeId),
	CONSTRAINT fk_Task_TaskStatus FOREIGN KEY (TaskStatusId)
		REFERENCES TaskStatus(TaskStatusId),
	CONSTRAINT fk_Task_Task FOREIGN KEY (ParentTaskId)
